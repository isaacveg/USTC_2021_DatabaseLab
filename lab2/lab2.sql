...
CREATE TABLE IF NOT EXISTS `mydb`.`Bank` (
  ...
  `property` DECIMAL(50,2) NOT NULL,
  PRIMARY KEY (`name`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`staffType`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`staffType` ;

CREATE TABLE IF NOT EXISTS `mydb`.`staffType` (
  `ID` CHAR(20) NOT NULL,
  `name` VARCHAR(45) NOT NULL,
  `tel` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`Costumer_has_SavingAccounts` (
  ...
  UNIQUE INDEX `SavingAccounts_ID_UNIQUE` (`SavingAccounts_ID` ASC) VISIBLE,
